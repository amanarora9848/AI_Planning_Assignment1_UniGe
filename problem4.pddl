...
(:goal (and
    (at drink1 table4) (at biscuit1 table4)
    (at drink2 table4) (at biscuit2 table4)
    (at drink3 table1) (at biscuit3 table1)
    (at drink4 table1) (at biscuit4 table1)
    (at drink5 table3) (at drink6 table3) (at drink7 table3) (at drink8 table3)
    (clean table4)
    (not (using_tray w1))
))

...
(:init
    ...
    (destination o1 table1) (destination o2 table4) ;ext3
    (elem o1 drink1) (elem o1 drink2) (elem o2 drink3) (elem o2 drink4) ;ext3
    (= (time_to_drink drink1) 4) (= (time_to_drink drink2) 4) (= (time_to_drink drink3) 4) (= (time_to_drink drink4) 4) ;ext3
)

(:goal (and
    (consumed o1) (consumed o2) ;ext3
